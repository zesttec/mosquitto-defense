...
def on_connect(client, userdata, flags, rc):
    ...
    #client.subscribe("sensors/device_9/control")
    client.subscribe("sensors/device_9")
    #client.subscribe("#")
...
def pub_command():
    ...
    # client.publish(topic="sensors/device_9/control", payload = published, retain=True)
    #print(published)
    rate = [99, 1]
...
client = mqtt.Client(client_id="control_app_9", clean_session = False)
#client.username_pw_set(username = "app_9", password = None)
client.username_pw_set(username = "app_9", password = None)
...
#client.publish(topic="sensors/device_9/control", payload = "app msg", retain=True)
