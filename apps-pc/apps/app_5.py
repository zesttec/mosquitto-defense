...
def on_connect(client, userdata, flags, rc):
    ...
    #client.subscribe("sensors/device_5/control")
    client.subscribe("sensors/device_5")
    #client.subscribe("#")
...
def pub_command():
    ...
    # client.publish(topic="sensors/device_5/control", payload = published, retain=True)
    #print(published)
    rate = [99, 1]
...
client = mqtt.Client(client_id="control_app_5", clean_session = False)
#client.username_pw_set(username = "app_5", password = None)
client.username_pw_set(username = "app_5", password = None)
...
#client.publish(topic="sensors/device_5/control", payload = "app msg", retain=True)
